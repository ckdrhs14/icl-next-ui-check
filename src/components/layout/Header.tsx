                    ...
                    <div className={styles.innerCon}>
                        <div className={styles.menuContainer}>
                            <Link href="/" className={styles.logo}>
                                ...
                                <img className={styles.colorLogo} src="/img/main/logo.svg" alt={a11y("logoAlt")} />
                                {/* eslint-disable-next-line @next/next/no-img-element */}
                        ...
                        <ul className={styles.btnWrap}>
                            <li className={styles.langBtnLi} onClick={(e) => { e.stopPropagation(); setLangOpen((p) => !p); }}>
                                ...
                                <span className={styles.btnTxt}>{locale === "ko" ? "KR" : locale === "en" ? "EN" : locale === "zh" ? "ZH" : locale === "vi" ? "VI" : locale === "mn" ? "MN" : "RU"}</span>
                                {langOpen && (
                                    <div className={styles.langDropdown}>
                                        ...
                                        >EN</button>
                                        <button
                                            className={locale === "zh" ? styles.langActive : ""}
                                            onClick={() => { switchLocale("zh"); setLangOpen(false); }}
                                        >ZH</button>
                                        <button
                                            className={locale === "vi" ? styles.langActive : ""}
                                            onClick={() => { switchLocale("vi"); setLangOpen(false); }}
                                        >VI</button>
                                        <button
                                            className={locale === "mn" ? styles.langActive : ""}
                                            onClick={() => { switchLocale("mn"); setLangOpen(false); }}
                                        >MN</button>
                                        <button
                                            className={locale === "ru" ? styles.langActive : ""}
                                            onClick={() => { switchLocale("ru"); setLangOpen(false); }}
                                        >RU</button>
                                    </div>
                                )}
                            </li>
                ...
                <div className={styles.detailMenuContainer} ref={detailRef}>
                    <div className={styles.detailMenuBox}>
                        <div className={styles.detailLogo}>
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src="/img/main/menu_logo.svg" alt={a11y("logoMenuAlt")} />
                        </div>
