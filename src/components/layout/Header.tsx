                    ...
                    <div className={styles.contInner}>
                        <div className={styles.quickBox}>
                            <Link href="/community/reservation" className={styles.quickBtn}>
                                <img src={li("/img/common/icon_cal_br.png")} alt="" />
                                <span>{t("quick.reserve")}</span>
                            </Link>
                            <div className={styles.quickLine} />
                            <Link href="/about/info" className={styles.quickBtn}>
                                <img src={li("/img/common/icon_map_br.png")} alt="" />
                                <span>{t("quick.location")} / {t("quick.clinicHours")}</span>
                            </Link>
                            <div className={styles.quickLine} />
                            <a href="tel:02-6956-8882" className={styles.quickBtn}>
                                <img src="/img/common/icon_call_br.png" alt="" />
                                <span>{t("quick.call")}</span>
                            </a>
                            <div className={styles.quickLine} />
                            <a href="https://pf.kakao.com/_rXGTG" target="_blank" rel="noopener noreferrer" className={styles.quickBtn}>
                                <img src={li("/img/common/icon_kakao_br.png")} alt="" />
                                <span>{t("quick.kakao")}</span>
                            </a>
                            <div className={styles.quickLine} />
                            <a href="https://m.booking.naver.com/booking/13/bizes/1003562" target="_blank" rel="noopener noreferrer" className={styles.quickBtn}>
                                <img src="/img/common/icon_naver_br.png" alt="" />
                                <span>{t("quick.naver")}</span>
                            </a>
                        </div>
                    </div>
                </div>
